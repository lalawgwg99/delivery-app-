                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                                ...
                                {/* Smart Cargo Tags */}
                                {order.tags?.includes('tv_fragile') && (
                                ...
                                {order.tags?.includes('fridge_upright') && (
                                    <span className="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-sky-50 text-sky-600 border border-sky-100">
                                        ❄️ 直立搬運
                                    </span>
                                )}
