...
app.post('/api/analyze', async (c) => {
	try {
      ...
      **D. distance_check (較遠路程判定)**
        ...
        - **判定標準**：若預估時間 **超過 20 分鐘**，請在 tags 中加入 'remote_area'。
        - **參考提示 (以下絕對視為較遠)**：
          - 北高雄：楠梓(Nanzih)、仁武(Renwu)、左營(Zuoying)、鼓山(Gushan)、大社(Dashe)、橋頭(Qiaotou)、岡山(Gangshan)及以北
          - 南高雄/遠郊：林園(Linyuan)、大樹(Dashu)、大寮(Daliao)
